...
export function HandPanel({
  ...
  return (
    <div
      className={`relative col-start-8 row-start-1 row-span-5 text-ttr-white bg-player-${player.color} rounded-l-md -mr-4 py-1 pl-0.5 pr-3 lg:pl-1.5 lg:pr-2.5 lg:rounded-l-lg lg:col-start-7 2xl:pr-3 2xl:pl-2 3xl:pr-3.5 3xl:pl-2.5`}
    >
      <button
        className={classNames(
          ...
          {
            'translate-x-22 lg:translate-x-36 xl:translate-x-44 2xl:translate-x-52 3xl:translate-x-72': actionsLeft,
          },
        )}
        onClick={() => {
          setActionsLeft(2);
        ...
        >
          ...
          >
            ...
            <p
              className={
                'absolute top-0 right-0 rounded-b-full rounded-tl-full rounded-tr-lg font-number font-bold text-gray-800 text-center text-xs h-4 w-6 lg:w-7 lg:h-7 lg:text-lg xl:w-8 xl:h-8 xl:text-xl xl:leading-9 2xl:w-10 2xl:h-10 2xl:leading-custom ' +
                (player.longRouteCard.finished ? 'bg-green-400' : 'bg-gray-200')
              }
            >
