...
export function GamePage({ playerList, playerCount }) {
  ...
  const locomotiveSVG = (
    <svg
      ...
      className="block transform -rotate-45 h-12 w-12 lg:h-20 lg:w-16 xl:h-28 xl:w-22 2xl:h-36 2xl:w-28"
      viewBox="0 0 36 21"
      fill="currentColor"
    >
  ...
  const rosterCards = roster.map((color) => {
    return (
      <button
        ...
        className={`relative bg-ttr-${color} inline-flex flex-row justify-center content-center overflow-hidden rounded-md shadow-xl w-12 h-12 ml-1.5 lg:w-16 lg:h-20 lg:ml-2 xl:h-28 xl:w-22 2xl:h-36 2xl:w-28`}
      >
    ...
    .map((player) => {
      return (
        <div
          ...
          className={`bg-player-${player.color} px-1 py-0 rounded-md text-2xs -ml-4 pl-3.5 w-9/12 flex justify-start content-center items-center lg:w-full lg:p-2 lg:text-xs xl:text-base 2xl:text-lg`}
        >
      ...
      >
        <div className="container relative h-full grid grid-cols-8 grid-rows-5 lg:grid-cols-7">
            ...
            <div className="fixed w-full bottom-0 right-0 lg:relative lg:col-span-5">
              <div
                className={classNames(
                  'relative rounded-t-md bg-red-900 mx-auto w-108 h-16 flex flex-row items-center content-around justify-between transform transition-transform p-2 lg:pb-0 lg:transform-none lg:h-full lg:w-full lg:max-w-xl lg:bg-opacity-0 lg:items-end lg:px-4 xl:max-w-3xl 2xl:max-w-5xl 2xl:px-8',
              ...
              >
                ...
                />
                <button className="filter drop-shadow-md rounded-md bg-yellow-500 text-ttr-white w-12 h-12 p-1 lg:w-16 lg:h-20 lg:p-2 xl:h-28 xl:w-22 xl:p-1 2xl:h-36 2xl:w-28 2xl:px-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 lg:h-12 lg:w-12 xl:h-20 xl:w-20 2xl:h-24 2xl:w-24"
                    viewBox="0 0 26 26"
                    fill="currentColor"
                  >
                ...
                <button className="filter drop-shadow-md rounded-md bg-blue-500 text-ttr-white w-12 h-12 p-1 ml-6 mr-3 lg:w-16 lg:h-20 lg:ml-10 lg:mr-3 lg:p-2 xl:h-28 xl:w-22 xl:p-1 2xl:h-36 2xl:w-28 2xl:px-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 lg:h-12 lg:w-12 xl:h-20 xl:w-20 2xl:h-24 2xl:w-24"
                    viewBox="0 0 25 26"
                ...
                <div className="h-12 lg:h-20 xl:h-28 2xl:h-36">
                  {rosterCards}
                </div>
              </div>
            </div>
          ...
          <div className="contents" id="player-hand">
            <div className="col-start-8 row-start-1 row-span-5 text-ttr-white bg-player-green rounded-l-md -mr-4 py-1 pl-1.5 pr-2.5 lg:rounded-l-lg lg:col-start-7">
