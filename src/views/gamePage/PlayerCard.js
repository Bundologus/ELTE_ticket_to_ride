    ...
    >
      ...
      <div className="flex items-center filter drop-shadow-md">
        <svg
          ...
          className="h-2 w-6 lg:h-4 lg:w-10"
          viewBox="0 0 50 18"
          fill="currentColor"
        >
        ...
        <p className="block filter drop-shadow-md ml-1 lg:ml-2 text-xs lg:text-sm">
      ...
      <div className="flex items-center justify-between filter drop-shadow-md lg:mb-1">
        ...
        <p className="block filter drop-shadow-md text-xs whitespace-nowrap lg:ml-1">
          x <span className="font-number">{player.trainCardCount}</span>
        </p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-4 w-4 lg:h-7 lg:w-7 lg:ml-1"
          viewBox="0 0 35 35"
          fill="currentColor"
        >
