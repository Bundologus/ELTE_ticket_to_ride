export function PlayerCard({ player }) {
  return (
    <div
      className={`bg-player-${player.color} text-ttr-white shadow-md rounded-r-md -ml-4 p-1 pl-3.5 pt-0.5 lg:rounded-r-lg lg:py-1.5 lg:pr-1.5`}
    >
      <h2 className="font-smallCaps font-semibold filter drop-shadow-md text-xs truncate lg:text-base xl:text-lg 2xl:text-xl">
        {player.name}
      </h2>
      <div className="flex items-center filter drop-shadow-md">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-2 w-6 lg:h-4 lg:w-10 xl:h-6 xl:w-12 2xl:h-10 2xl:w-18"
          viewBox="0 0 50 18"
          fill="currentColor"
        >
        ...
        <p className="block filter drop-shadow-md ml-1 lg:ml-2 text-xs lg:text-sm xl:text-base 2xl:text-xl">
      ...
      <div className="flex items-center justify-between filter drop-shadow-md lg:mb-1 lg:pr-1 xl:pr-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-4 w-4 lg:h-7 lg:w-7 xl:h-10 xl:w-10 2xl:h-14 2xl:w-14"
          viewBox="0 0 35 35"
          fill="currentColor"
        >
        ...
        <p className="block filter drop-shadow-md text-xs whitespace-nowrap lg:ml-0.5 xl:text-base 2xl:text-xl">
          x <span className="font-number">{player.trainCardCount}</span>
        </p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-4 w-4 lg:h-7 lg:w-7 lg:ml-1 xl:h-10 xl:w-10 2xl:h-14 2xl:w-14"
          viewBox="0 0 35 35"
          fill="currentColor"
        >
